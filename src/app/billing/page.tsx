...
export default function BillingPage() {
  return (
    <div className="w-full h-max flex flex-col justify-between items-center gap-y-5 pb-2 pt-6">
      <div className="w-full h-full flex justify-between items-center max-lg:flex-wrap gap-4">
        <div className="w-2/3 h-max max-lg:w-full flex flex-wrap justify-between items-center gap-4">
          <div className="billingFirstCardBg h-[260px] w-[49%] max-[1440px]:w-full flex flex-col justify-between items-center p-7">
          ...
          <div className="MainCards h-[260px] w-[49%] max-[1440px]:w-full flex flex-col justify-between items-center p-7">
          ...
          <div className="MainCards min-h-[185px] h-max w-full flex flex-col justify-between items-center gap-y-5 p-7">
            <div className="h-max w-full flex justify-between items-center">
              ...
              <button className="text-xs font-bold bg-bgBlue px-5 py-3 rounded-xl duration-300 hover:scale-110">ADD NEW CARD</button>
            </div>
