    ...
    return (
        <div className="min-w-max w-1/2 max-md:w-full flex max-md:flex-col justify-center items-center gap-3 px-2">
            <button
                ...
                className={`min-w-36 max-md:w-full uppercase flex justify-center items-center gap-2 text-sm rounded-xl px-3 py-2 ${activeTab === 'Overview' ? 'bg-[#0066cc]' : ''} duration-500`}
            >
            ...
            <button
                ...
                className={`min-w-36 max-md:w-full uppercase flex justify-center items-center gap-2 text-sm rounded-xl px-3 py-2 ${activeTab === 'Teams' ? 'bg-[#0066cc]' : ''} duration-500`}
            >
                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" color="white" className="MuiTab-iconWrapper" style={{ color: "white" }} height="16px" width="16px" xmlns="http://www.w3.org/2000/svg">
            ...
            <button
                ...
                className={`min-w-36 max-md:w-full uppercase flex justify-center items-center gap-2 text-sm rounded-xl px-3 py-2 ${activeTab === 'Projects' ? 'bg-[#0066cc]' : ''} duration-500`}
            >
                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" color="white" className="MuiTab-iconWrapper" style={{ color: "white" }} height="16px" width="16px" xmlns="http://www.w3.org/2000/svg">
